...
dihasilkan, serta capaian hasil pendidikan @fitriani2024tracer. 
  ...
  + *Waktu Tunggu Lulusan (Tabel 8.d.1)* \
    ...
    // [OPTIONAL] Uncomment jika ingin menyertakan tangkapan layar tabel asli dari PDF
    // #figure(image("resources/images/banpt_tabel_8d1.png", width: 90%), caption: [Tabel 8.d.1 Waktu Tunggu Lulusan]) <fig:banpt_8d1>
  ...
  + *Kesesuaian Bidang Kerja (Tabel 8.d.2)* \
    ...
    // #figure(image("resources/images/banpt_tabel_8d2.png", width: 90%), caption: [Tabel 8.d.2 Kesesuaian Bidang Kerja]) <fig:banpt_8d2>
  ...
  + *Tempat Kerja Lulusan (Tabel 8.e.1)* \
    ...
    // #figure(image("resources/images/banpt_tabel_8e1.png", width: 90%), caption: [Tabel 8.e.1 Tempat Kerja Lulusan]) <fig:banpt_8e1>
  ...
  + *Kepuasan Pengguna (Tabel 8.e.2)* \
    ...
    // #figure(image("resources/images/banpt_tabel_8e2.png", width: 90%), caption: [Tabel 8.e.2 Kepuasan Pengguna Lulusan]) <fig:banpt_8e2>
...
#chapter(3, "Desain dan Implementasi")[
  ...
  Fitur ini dirancang untuk melengkapi modul "Manajemen Kuesioner" di sisi _backend_ (yang dikembangkan oleh mitra penelitian). Konsep utamanya adalah *Data-Driven UI*, di mana antarmuka formulir tidak digambarkan secara statis dalam kode HTML/Blade, melainkan dihasilkan secara otomatis (_rendered_) berdasarkan skema JSON yang diterima dari server.
  ...
  2.  *Component Mapping*: Sistem memetakan setiap tipe pertanyaan ke dalam komponen UI atomik yang sesuai. Misalnya, tipe `text` akan memanggil komponen `<TextInput />`, dan tipe `scale` akan memanggil `<LikertScale />`.
  ...
  #figure(
    ...
    caption: [Arsitektur Desain Kuesioner Dinamis (_Data-Driven UI_)],
  ...
  Bagian ini menjelaskan rancangan antarmuka pengguna (_User Interface_) yang akan diimplementasikan. Rancangan ini dibuat berdasarkan analisis kebutuhan pengguna dan prinsip-prinsip _User Centered Design_ yang telah dibahas pada sub-bab 3.1.
